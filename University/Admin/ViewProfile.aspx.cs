...
namespace University.Admin
{
    public partial class ViewProfile : System.Web.UI.Page
    {
        ...
        protected void ImageButtonUpdate_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (em.updateEMPLOYEES_TABLE(username, password, name, phone, gender, image, de_id, head, active))
            {
                ImageButtonUpdate.Attributes.Add("OnClick","alert('Update successful')");
