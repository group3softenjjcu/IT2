<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="ViewSubject.aspx.cs" Inherits="University.ViewSubject" %>
              ...
              <ul>
                ...
                <ItemTemplate>
                        <tr>
                            ...
                            <td align="center" ><a href='<%# "Appointment.aspx?sub_id="+Eval("sub_id") %>'>Book</a></td>
                        </tr>
                </ItemTemplate>
