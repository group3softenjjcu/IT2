<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditSubject.aspx.cs" Inherits="University.Admin.EditSubject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="gadget">
        ...
        <div class="gadgetblock">   
            ...
            <tr>    
                <th></th>            
                <td><asp:ImageButton ID="ImageButtonUpdate" runat="server"  ImageUrl="~/Admin/images/function/update.jpg" OnClick="ImageUpdate_Click"/></td>                
                 <td />
            </tr>
          </table>
                    </ContentTemplate>
